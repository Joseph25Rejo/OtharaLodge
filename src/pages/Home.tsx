...
const Feature: React.FC<FeatureProps> = ({ icon, title, description, fromLeft = true }) => {
  ...
  return (
    <div
      ref={ref}
      className={`group p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-500 opacity-0 transform ${
        inView
    ...
    >
      <div className="flex items-center space-x-4">
        <div className="flex-shrink-0">
          <div className="p-3 bg-indigo-100 rounded-lg group-hover:bg-indigo-600 group-hover:text-white transition-colors duration-300">
            {icon}
          </div>
        </div>
        <div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 opacity-0 animate-[fadeInLeft_1s_ease-out_forwards]">
              <div className="space-y-4">
                <h1 className="text-5xl font-bold text-gray-900 leading-tight animate-[fadeInUp_1s_ease-out_0.2s_forwards] opacity-0">
                  Experience Authentic
                  <span className="text-gray-900"> Kerala</span> Hospitality
                </h1>
                <p className="text-xl text-gray-600 animate-[fadeInUp_1s_ease-out_0.4s_forwards] opacity-0">
              ...
              <div className="flex space-x-4 opacity-0 animate-[fadeInUp_1s_ease-out_1.4s_forwards]">
                <Link
                  to="/booking"
                  className="inline-flex items-center px-6 py-3 rounded-lg bg-indigo-600 text-white font-medium hover:bg-indigo-700 transition-colors duration-300 hover:scale-105 transform"
                >
                  Book Your Stay
                ...
                <Link
                  to="/contact"
                  className="inline-flex items-center px-6 py-3 rounded-lg border-2 border-indigo-600 text-indigo-600 font-medium hover:bg-indigo-50 transition-colors duration-300"
                >
                  Contact Us
                </Link>
              </div>
            ...
            {/* Right Content - Image */}
            <div className="relative lg:ml-8 opacity-0 animate-[fadeInRight_1s_ease-out_0.5s_forwards]">
              ...
              <img
                src={logo}
                alt="Othara Lodge"
                className="relative w-full max-w-lg mx-auto rounded-2xl shadow-xl transform hover:scale-105 transition-transform duration-300"
              />
            </div>
          </div>
        </div>
      ...
      <div className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose Othara Lodge?</h2>
            <p className="text-xl text-gray-600">Experience the perfect blend of comfort, convenience, and authentic Kerala hospitality.</p>
          </div>
      ...
      <div className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Explore Nearby Attractions</h2>
            <p className="text-xl text-gray-600">Discover the natural beauty and cultural heritage around Othara Lodge</p>
          </div>
      ...
      <div className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-xl text-gray-600">Don't just take our word for it - hear from our satisfied guests</p>
          </div>
      ...
      <div className="py-24 bg-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-indigo-600 mb-4">Ready to Experience Kerala?</h2>
            <p className="text-xl text-gray-700 mb-8">Book your stay now and create unforgettable memories</p>
            <Link
              to="/booking"
              className="inline-flex items-center px-8 py-4 rounded-lg bg-indigo-600 text-white font-medium hover:bg-indigo-700 transition-colors duration-300 hover:scale-105 transform"
            >
              Book Your Stay
              <ChevronRight className="ml-2 h-5 w-5" />
            </Link>
